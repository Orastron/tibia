...
ifeq ($(TEMPLATE), android)
	...
	ANDROIDX_CORE_VERSION := 1.19.0
	ANDROIDX_LIFECYCLE_COMMON_VERSION := 2.10.0
	ANDROIDX_VERSIONEDPARCELABLE_VERSION := 1.2.1
	KOTLIN_STDLIB_VERSION := 2.4.0
	KOTLINX_COROUTINES_CORE_VERSION := 1.11.0
	KOTLINX_COROUTINES_CORE_JVM_VERSION := 1.11.0
endif
